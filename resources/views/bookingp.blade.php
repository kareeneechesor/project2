...
<script>
    ...
    function goToStep(step) {
        ...
        if (step === 'step3') {
            ...
            document.getElementById('summary-price').innerText = formData.price;
    ...
    formData.service = '{{ request('service') }}'; // Ensure this matches your backend logic
    formData.price = '{{ request('price') }}'; // Ensure this matches your backend logic
            ...
            <div class="col-lg-8 mx-auto">
                <div class="form-section">
                   ...
                   <div id="step1" class="step-section active">
                       <h3 class="text-center">เลือกโปรโมชั่น</h3>
                       <p class="text-center">เลือกโปรโมชั่นที่คุณต้องการจอง</p>

                       <!-- Promotion Selection -->
                       <div class="form-group">
                           <h5>โปรโมชั่นนวดสำหรับคุณ <span class="badge-new">ใหม่</span></h5>
                           <div class="booking-card d-flex flex-column align-items-center">
                               <img src="{{ request('image') }}" alt="Promotion Image" class="img-fluid mb-3" style="max-width: 50%; height: auto;">
                               <h4 class="text-center">{{ request('service') }}</h4> <!-- Display Promotion Title Here -->
                               <p class="text-danger text-center">ราคา: {{ request('price') }} บาท</p> <!-- Display Price Here -->
...
<div id="step3" class="step-section">
    ...
    <div class="form-group">
        ...
        <p><strong>ชื่อโปรโมชั่น:</strong> <span id="summary-service">{{ request('service') }}</span></p>
    ...
    <div class="d-flex justify-content-center mb-3">
        ...
        <form action="{{ route('promotion_bookings.store') }}" method="POST" style="flex: 1;">            
