            ...
            <div class="col-lg-3 col-md-6 mb-4 d-flex">
                <div class="card promotion-card">
                    ...
                    <div class="card-body d-flex flex-column">
                        <p>โปรโมชั่นพิเศษ! ประหยัดมากกว่า เริ่มต้นเพียง 490 บ.</p>
                        <a href="/bookingp?image=forms/img/pg7.jpg&title=โปรโมชั่นพิเศษ! ประหยัดมากกว่า เริ่มต้นเพียง 490 บ." class="promotion-btn mt-auto">จอง</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 mb-4 d-flex">
                <div class="card promotion-card">
                    ...
                    <div class="card-body d-flex flex-column">
                        <p>บริการสปาหน้าใสที่ทุกคนที่ได้ลองแล้วหลงรัก กลับมาใช้บริการซ้ำมากที่สุด จองตอนนี้ ลด 10% เหลือเพียง 590 บ.</p>
                        <a href="/bookingp?image=forms/img/pg6.jpg&title=บริการสปาหน้าใสที่ทุกคนที่ได้ลองแล้วหลงรัก" class="promotion-btn mt-auto">จอง</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 mb-4 d-flex">
                <div class="card promotion-card">
                    ...
                    <div class="card-body d-flex flex-column">
                        <p>จองเลย! โปรโมชั่นฉ่ำเลยจ้า รีบๆใช้ก่อนหมดโปร</p>
                        <a href="/bookingp?image=forms/img/pg3.jpg&title=จองเลย! โปรโมชั่นฉ่ำเลยจ้า รีบๆใช้ก่อนหมดโปร" class="promotion-btn mt-auto">จอง</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 mb-4 d-flex">
                <div class="card promotion-card">
                    <img src="forms/img/p6.6.jpg" alt="Promo 4" class="promotion-image">
                    <div class="card-body d-flex flex-column">
                        <p>โปรสุดคุ้ม! จองบริการนวดครั้งต่อไป 60 นาที เริ่มต้นเพียง 599 บ. ใช้โปรได้ไม่จำกัดครั้ง</p>
                        <a href="/bookingp?image=forms/img/p6.6.jpg&title=โปรสุดคุ้ม! จองบริการนวดครั้งต่อไป 60 นาที" class="promotion-btn mt-auto">จอง</a>
                    </div>
                </div>
            </div>
        </div>
